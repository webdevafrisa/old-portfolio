...
const people = [
  ...
  return (
    <div className="flex flex-row items-center justify-around w-full mb-10 ">
      {people.map((testimonial, idx) => (
        ...
        >
          ...
          <Image
            ...
            className="relative object-cover object-top w-20 h-20 transition duration-500 border-2 border-white rounded-full group-hover:scale-105 group-hover:z-30"
          />
        </div>
      ))}
    </div>
